...
1. Pick a hook in `_HOOKS` (say `_hook_wasteful`). Read its docstring — it names the CONTRACTS.md
   rule it implements, and records what a trace-only prosecutor can and cannot reach.
